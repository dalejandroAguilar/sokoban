...
public class LevelsManage {
    ...
    public static String[] fromFileToStringArray(File file) {
    ...
    public static ArrayList<String[]> getAllFiles(String url) {
        ArrayList<String[]> level_All = new ArrayList<String[]>();
        int i = 1;
        while (fileExist("levels/level_" + i + ".txt")) {
            level_All.add(fromFileToStringArray(new File(/*url+"\\*/"levels/level_" + i + ".txt")));
            System.out.print(i);
            i++;
        }
        return level_All;
